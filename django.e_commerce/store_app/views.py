...
prices_1 = re.findall(price_pattern, text)

# Print the extracted price list
for price_1 in prices_1:
    print(price_1)
...
#     return render(request,"scooters.html",{'sc_list':sc_list})
...
# def watches(request):
#     return render(request,"watches.html",{'wa_list':wa_list})
